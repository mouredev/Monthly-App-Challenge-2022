...
import 'package:brais_wars/Home/widgets/search_delegat.dart';
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SizedBox(
              ...
              child: FutureBuilder(
                future: homeServices.getNextCharacter(),
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  return listOfCharacters(
                      context, character.results, _scrollController);
                },
              )),
        ),
      ),
          ...
          child: Container(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                var imageName = result?[index].name?.replaceAll(' ', '');
                return Row(
